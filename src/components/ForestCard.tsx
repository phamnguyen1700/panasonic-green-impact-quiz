import { Badge, Card } from "@elemental-fx/crystall-ui";
...
export function ForestCard({
  ...
  const frameClass = size === "md" ? "aspect-[3/4.4] w-[13.5rem]" : "aspect-[3/4.2] w-[9.5rem]";
  const paddingClass = size === "md" ? "p-5" : "p-4";
      ...
      >
        ...
        <header className="relative flex items-start gap-2 text-forest-900/85">
          ...
          <div className="leading-tight">
            ...
            <Badge
              className={cn(
                "mt-1 border-forest-900/10 bg-forest-900/10 text-forest-900/70",
